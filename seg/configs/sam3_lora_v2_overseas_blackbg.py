...
Differences vs the original v2 (`sam3_lora_windblade_8class_v2.py`):
  ...
  4. work_dir = runs/sam3_lora_v2_overseas_blackbg (separate from v2's dir).
...
work_dir = '/home/work/workspace/azka5/dmdd_pipeline/runs/sam3_lora_v2_overseas_blackbg'
